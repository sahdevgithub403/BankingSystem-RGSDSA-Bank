...
%>
    <nav class="navbar navbar-dark bg-primary fixed-top">
      ...
      <div class="container">
        <div class="title"><p class="text-center"><p1 class="fs-4">Your balance Detail</p1></p></div>
        <!-- Content here -->
        <label><span>Name :</span>${fName} ${lName}</label><br>
<label><span>Account No :</span>${AccNo}</label><br>
<label><span>Your Balance : </span>${balance}</label><br>
