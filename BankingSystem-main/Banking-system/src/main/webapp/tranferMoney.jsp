...
%>
    <nav class="navbar navbar-dark bg-primary fixed-top">
      ...
      <div class="container">
        ...
        <!-- Content here -->
        <form action="customerCtrls?action=dotransfer&CustId=${mainUser}" method="post">
            <div class="mb-3">
                <label for="receiverName" class="form-label">Receiver's First Name</label>
            ...
            <div class="d-grid gap-2 d-md-flex justify-content-between">
                ...
                <button class="btn btn-primary trigger-popup" type="button">Send Money</button>
            </div>
